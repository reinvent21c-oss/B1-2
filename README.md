...
👉 **[구글 드라이브 내 영상 보기(ver10sec)](https://drive.google.com/file/d/1Rxz_Aex3uG1jhnK_YIGfDX9w3OGgOtDU/view?usp=sharing)**

👉 **[영상 보기(ver15sec)](./assets/AirK_광고15초버전.mp4)**
👉 **[구글 드라이브 내 영상 보기(ver15sec)](https://drive.google.com/file/d/1rtz2nlWdUI1zoqMozTaMnrvL5m9ML1fr/view?usp=sharing)**
...
| 영상 사양 | 15초(표준) / 10초(10초 이내 규격) / 1080p / 30fps / H.264·AAC / 16:9 |
...
> 상세 이슈·대응·프롬프트 수정 전/후 기록은 **[스토리보드 PDF](./aerok_storyboard_v2.4.pdf)** 참고
...
👉 **[기획 문서 PDF 보기](./aerok_storyboard_v2.4.pdf)**

포함 내용: 브랜드 아이덴티티 · 캠페인 목표 · 씬별 상세(8개 필수 필드) · 입력 프롬프트 원문 · 프롬프트 수정 전/후 사례(3건) · 멀티모달 이슈 기록 · 심층 Q&A(도구 교체·크레딧 전략·시간 단축 재구성)

---

<sub>Codyssey AI Native · 멀티미디어 미션 B1-2 · 교육 목적 가상 광고</sub>
